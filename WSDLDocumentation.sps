...
<structure version="14" html-doctype="HTML4 Transitional" compatibility-view="IE9" relativeto="*XML" encodinghtml="UTF-8" encodingrtf="ISO-8859-1" encodingpdf="UTF-8" useimportschema="1" embed-images="1" enable-authentic-scripts="1" authentic-scripts-in-debug-mode-external="0" generated-file-location="DEFAULT">
	...
	<schemasources>
		<namespaces>
			<nspair prefix="n1" uri="http://www.uvm.edu/documentation"/>
		</namespaces>
		<schemasources>
				...
				<children>
					...
					<template subtype="source" match="XML">
						<children>
													...
													<tgridrow>
														<children>
															...
															<tgridcell>
																<properties valign="top"/>
																<children>
																	<template subtype="userdefined" match="(n1:Element|n1:ComplexType|n1:SimpleType)">
																		<children>
																			<calltemplate subtype="named" match="WSDLBookmarkItem">
																				<parameters/>
																			</calltemplate>
							...
							<template subtype="element" match="n1:WSDLDocumentation">
								<children>
									<template subtype="userdefined" match="(n1:Service|n1:Binding|n1:PortType|n1:Message|n1:Element|n1:ComplexType|n1:SimpleType)[@id]">
										<children>
											<condition>
												<children>
